...
const ProjectComponent = (props: Props) => {
  ...
  return (
    <div data-aos={props.dataAos} data-aos-duration={props.dataAosDuration} data-aos-easing={props.dataAosEasing} className='md:first-of-type:ml-0 max-w-[300px] w-full h-96 ml-2 mb-2 rounded border-solid border-2 border-gray-500 bg-gray-100 p-6 max-[600px]:bg-sky-300'>
      ...
      <div className="flex flex-1 flex-col h-[100%]">
        ...
        <a href={props.url} className='flex mt-4 items-center justify-center font-bold rounded bg-purple p-[14px] text-[#fff] decoration-none mb-6' >Acessar</a>
